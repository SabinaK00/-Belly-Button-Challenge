...
function buildCharts(sample) {
  d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
    ...
    // Build a Bubble Chart with shades of green
    let bubble_trace = {
      x: otu_ids,
      y: sample_values,
      mode: 'markers',
      marker: {
        ...
        size: sample_values,
        colorscale: [
          [0, 'rgb(229, 245, 224)'],  // light green
          [0.5, 'rgb(161, 217, 155)'], // medium green
          [1, 'rgb(0, 109, 44)']       // dark green
        ]
      },
      text: otu_labels
    };
    ...
    // Build a Bar Chart with shades of green
    let trace1 = {
